local N = require("Common.Tools.flatbuffers.numTypes")
local ba = require("Common.Tools.flatbuffers.binaryarray")
local compat = require("Common.Tools.flatbuffers.compat")
