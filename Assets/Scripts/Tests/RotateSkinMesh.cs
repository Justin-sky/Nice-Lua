...
[ExecuteAlways]
public class RotateSkinMesh : MonoBehaviour
{
    [HideInInspector]
    ...
    public void DoUpdateMaterial()
    {
        ...
        this.GetComponent<SkinnedMeshRenderer>().GetPropertyBlock(mb);
        mb.SetMatrix("_RotationMatrix", rot);
        this.GetComponent<SkinnedMeshRenderer>().SetPropertyBlock(mb);
